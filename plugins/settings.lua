...
local function run(msg, matches)
		...
		elseif matches[2] == 'tgservices' then
            ...
            return
                ...
                elseif matches[2] == 'floodtime' then
                    ...
                    return
                elseif matches[2] == 'تعدادفلود' then
                    if not matches[3] then
                    else
    ...
    elseif matches[1] == 'بسته' and matches[2] then
